...
--
-- Host: localhost
-- Generation Time: Aug 05, 2021 at 04:29 PM
...
-- Database: `DTP`
--
CREATE DATABASE IF NOT EXISTS `DTP` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `DTP`;
